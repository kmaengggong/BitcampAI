...
hist = model.fit(x_train, y_train, validation_split=0.2, callbacks=ealryStopping, epochs=5000, batch_size=128)

model.save_weights("./_save/tf18_save_weights_california.h5")
